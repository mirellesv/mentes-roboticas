...
void loop() {
  ...
  if (contador >= 200) {
    ...
    Serial.println("**********************************************");
    Serial.print("Media Pot1: "); Serial.print(media1); Serial.print(" -> Angulo: "); Serial.println(motor1);
    Serial.print("Media Pot2: "); Serial.print(media2); Serial.print(" -> Angulo: "); Serial.println(motor2);
    Serial.print("Media Pot3: "); Serial.print(media3); Serial.print(" -> Angulo: "); Serial.println(motor3);
    Serial.print("Media Pot4: "); Serial.print(media4); Serial.print(" -> Angulo: "); Serial.println(motor4);
